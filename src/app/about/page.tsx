...
function HeroSlider({ slides, title, subtitle, description }: {
  ...
  return (
    <section className="relative py-20 px-6 text-center overflow-hidden" style={{ minHeight: "420px" }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        {subtitle && <p className="text-orange-400 font-medium text-sm uppercase tracking-widest mb-4">{subtitle}</p>}
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-blue-50 rounded-xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed">To provide quality, affordable education to every child in our community — regardless of their background. We believe every student deserves a chance to build a bright future.</p>
          </div>
          <div className="bg-orange-50 rounded-xl p-8">
            ...
            <p className="text-gray-600 leading-relaxed">To become the most trusted educational institution in Ayodhya — where students grow not just academically, but as responsible citizens and future leaders.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-blue-900 rounded-xl p-10">
            <div className="w-20 h-20 rounded-full overflow-hidden mx-auto mb-6 ring-4 ring-orange-400 relative">
              <Image src="/images/rajesh_kumar.jpg" alt="Principal Rajesh Kumar" fill className="object-cover object-top" sizes="80px" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="rounded-2xl p-6 text-left" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(249,115,22,0.4)" }}>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-orange-400 relative">
                  <Image src="/images/rajabhavesh1.jpg" alt="Raja Bhavesh" fill className="object-cover object-top" sizes="56px" />
                </div>
              ...
              <div className="flex flex-col gap-2">
                {[
                  { label: "District Rank 3", detail: "High School — Ayodhya (2018)", color: "text-orange-400" },
                  { label: "District Rank 1 🥇", detail: "Intermediate — Ayodhya (2020)", color: "text-orange-400" },
                  { label: "JEE Qualified", detail: "Mains & Advanced — IIT BHU (2021)", color: "text-orange-400" },
                ].map((a, j) => (
            ...
            <div className="rounded-2xl p-6 text-left" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(34,197,94,0.4)" }}>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-orange-400 relative">
                  <Image src="/images/renu.jpg" alt="Renu Kumari" fill className="object-cover object-top" sizes="56px" />
                </div>
                <div className="flex-1">
              ...
              <div className="flex flex-col gap-2">
                {[
                  { label: "NEET Qualified", detail: "MBBS - RDASMC Ayodhya (2019)", color: "text-green-400" },
                  { label: "Medical Doctor", detail: "From TSIC to MBBS — a proud journey", color: "text-green-400" },
                ].map((a, j) => (
                  <div key={j} className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2">
                    <span className={`${a.color} text-xs font-medium w-28 shrink-0`}>{a.label}</span>
                    <span className="text-blue-200 text-xs">{a.detail}</span>
            ...
            <div className="rounded-2xl p-6 text-left" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(34,197,94,0.4)" }}>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-orange-400 relative">
                  <Image src="/images/agrima.jpg" alt="Agrima Singh" fill className="object-cover object-top" sizes="56px" />
                </div>
                <div className="flex-1">
              ...
              <div className="flex flex-col gap-2">
                {[
                  { label: "District Rank 4", detail: "High School — Ayodhya (2020)", color: "text-green-400" },
                  { label: "NEET Qualified", detail: "MBBS - MVASMC Basti (2024)", color: "text-green-400" },
                ].map((a, j) => (
                  <div key={j} className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2">
                    <span className={`${a.color} text-xs font-medium w-28 shrink-0`}>{a.label}</span>
                    <span className="text-blue-200 text-xs">{a.detail}</span>
            ...
            <div className="rounded-2xl p-6 text-left" style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(99,102,241,0.4)" }}>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-full flex items-center justify-center text-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 flex-shrink-0">🏅</div>
                <div className="flex-1">
              ...
              <div className="flex flex-col gap-2">
                {[
                  { label: "Rank 1 — District", detail: "Intermediate, Ayodhya (2020)", color: "text-indigo-400" },
                  { label: "Rank 3 — District", detail: "High School, Ayodhya (2018)", color: "text-indigo-400" },
                  { label: "Rank 4 — District", detail: "High School, Ayodhya (2020)", color: "text-indigo-400" },
                ].map((a, j) => (
                  <div key={j} className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2">
                    <span className={`${a.color} text-xs font-medium w-28 shrink-0`}>{a.label}</span>
                    <span className="text-blue-200 text-xs">{a.detail}</span>
